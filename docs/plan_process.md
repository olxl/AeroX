...
### 主要文件（待创建）
- aerox_ecs/src/world.rs: World 包装
- aerox_ecs/src/events.rs: 网络事件
- aerox_ecs/src/components.rs: 基础组件
- aerox_ecs/src/systems.rs: 系统定义
...
- examples/chat_room.rs: 聊天室
- tests/integration_test.rs: 集成测试
- benches/benchmark.rs: 性能测试
